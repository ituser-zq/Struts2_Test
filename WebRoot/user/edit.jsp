...
<HTML>
	...
	<body>
		<s:form action="user_edit" namespace="/" method="post" id="userAction_save_do" name="Form1" enctype="multipart/form-data" theme="simple">
			&nbsp;
			<table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff" colspan="3">
						...
						<s:textfield name="logonName" id="userAction_save_do_logonName" cssClass="bg" value="%{model.logonName}"/>
					</td>
				</tr>
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff">
						<s:password  name="logonPwd" id="logonPwd" showPassword="true" value="%{model.logonPwd}"/>
					</td>
					<td align="center" bgColor="#f5fafe" class="ta_01">
						用户姓名：
					</td>
					<td class="ta_01" bgColor="#ffffff">
						<s:textfield name="userName" id="userAction_save_do_userName" class="bg" value="%{model.userName}"/>
					</td>
				</tr>
				<tr>
					<td align="center" bgColor="#f5fafe" class="ta_01">
					...
					<td class="ta_01" bgColor="#ffffff">
						<s:select list="{'博士','硕士','研究生','本科','专科','高中'}" name="education" id="education" headerKey="" headerValue="--选择学历--" value="%{model.education}"></s:select>
					</td>
				</tr>
				<tr>
					<td align="center" bgColor="#f5fafe" class="ta_01">
					...
					<td class="ta_01" bgColor="#ffffff">
						<s:textfield name="birthday" size="20" readonly="true" id="birthday" value="%{model.birthday}"></s:textfield>
					</td>
					<td align="center" bgColor="#f5fafe" class="ta_01">
						电话：
					</td>
